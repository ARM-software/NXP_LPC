...
static int32_t I2S0_Initialize (ARM_SAI_SignalEvent_t cb_event) {
  ...
  if (i2s->rx_pins.sck != NULL) {
    ...
    PIN_Configure (i2s->rx_pins.sck->Portnum, i2s->rx_pins.sck->Pinnum, i2s->rx_pins.func_sck, 0, 0);
...
#if defined (LPC175x_6x)
    PIN_Configure (i2s->rx_pins.ws->Portnum, i2s->rx_pins.ws->Pinnum, i2s->rx_pins.func_ws, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (i2s->rx_pins.sda->Portnum, i2s->rx_pins.sda->Pinnum, i2s->rx_pins.func_sda, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (i2s->rx_pins.mclk->Portnum, i2s->rx_pins.mclk->Pinnum, i2s->rx_pins.func_mclk, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.sck->Portnum, i2s->tx_pins.sck->Pinnum, i2s->tx_pins.func_sck, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.ws->Portnum, i2s->tx_pins.ws->Pinnum, i2s->tx_pins.func_ws, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.sda->Portnum, i2s->tx_pins.sda->Pinnum, i2s->tx_pins.func_sda, 0, 0);
#elif defined (LPC177x_8x)
...
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.mclk->Portnum, i2s->tx_pins.mclk->Pinnum, i2s->tx_pins.func_mclk, 0, 0);
#elif defined (LPC177x_8x)
...
static int32_t I2S0_Uninitialize (void) {
  ...
  if (i2s->rx_pins.sck != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->rx_pins.sck->Portnum, i2s->rx_pins.sck->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (i2s->rx_pins.ws != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->rx_pins.ws->Portnum, i2s->rx_pins.ws->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (i2s->rx_pins.sda != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->rx_pins.sda->Portnum, i2s->rx_pins.sda->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (i2s->rx_pins.mclk != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->rx_pins.mclk->Portnum, i2s->rx_pins.mclk->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (i2s->tx_pins.sck != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.sck->Portnum, i2s->tx_pins.sck->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (i2s->tx_pins.ws != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.ws->Portnum, i2s->tx_pins.ws->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (i2s->tx_pins.sda != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.sda->Portnum, i2s->tx_pins.sda->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
  ...
  if (i2s->tx_pins.mclk != NULL) {
#if defined (LPC175x_6x)
    PIN_Configure (i2s->tx_pins.mclk->Portnum, i2s->tx_pins.mclk->Pinnum, 0, 0, 0);
#elif defined (LPC177x_8x)
