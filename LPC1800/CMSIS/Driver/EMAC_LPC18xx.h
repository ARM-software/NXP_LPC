...
#define EMAC_MMAR_CR_Div102 (0x4U << 2)     // Clk_M3_Ethernet: 150-250 MHz
#define EMAC_MMAR_CR_Div62  (0x1U << 2)     // Clk_M3_Ethernet: 100-150 MHz
#define EMAC_MMAR_CR_Div42  (0x0U << 2)     // Clk_M3_Ethernet:  60-100 MHz
#define EMAC_MMAR_CR_Div26  (0x3U << 2)     // Clk_M3_Ethernet:  35- 60 MHz
#define EMAC_MMAR_CR_Div16  (0x2U << 2)     // Clk_M3_Ethernet:  20- 35 MHz
