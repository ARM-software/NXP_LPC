 ...
 * $Revision:    V1.0
 *
 * Project:      I2S Driver Definitions for NXP LPC40xx
 * -------------------------------------------------------------------------- */

#ifndef __I2S_LPC40XX_H
#define __I2S_LPC40XX_H
