...
static int32_t Initialize (ARM_MCI_SignalEvent_t cb_event) {
  ...
  PIN_Configure (RTE_SD_DAT0_PORT, RTE_SD_DAT0_PIN, 2U | IOCON_MODE_PLAIN | IOCON_SLEW_ENABLE | SD_DAT0_IOCON_CFG);

  #if (MCI_BUS_WIDTH_4 != 0U)
  PIN_Configure (RTE_SD_DAT1_PORT, RTE_SD_DAT1_PIN, 2U | IOCON_MODE_PLAIN | IOCON_SLEW_ENABLE | SD_DAT1_IOCON_CFG);
  ...
  #if (MCI_PWR_PIN != 0U)
  PIN_Configure (RTE_SD_PWR_PORT, RTE_SD_PWR_PIN, 2U | IOCON_MODE_PLAIN | SD_PWR_IOCON_CFG);
