...
/* Defines for P1.5, P1.6 and P1.7 analog/digital bit handling */
#if ((RTE_SD_PWR_PORT == 1) && (RTE_SD_PWR_PIN == 5))
#define SD_PWR_IOCON_CFG      IOCON_DIGITIAL_MODE
#else
#define SD_PWR_IOCON_CFG      0U
#endif

#if ((RTE_SD_DAT0_PORT == 1) && (RTE_SD_DAT0_PIN == 6))
#define SD_DAT0_IOCON_CFG     IOCON_DIGITIAL_MODE
#else
#define SD_DAT0_IOCON_CFG     0U
#endif

#if ((RTE_SD_DAT1_PORT == 1) && (RTE_SD_DAT1_PIN == 7))
#define SD_DAT1_IOCON_CFG     IOCON_DIGITIAL_MODE
#else
#define SD_DAT1_IOCON_CFG     0U
#endif
