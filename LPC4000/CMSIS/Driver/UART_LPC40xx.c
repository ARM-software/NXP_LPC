 ...
 * Project:      USART Driver for NXP LPC40xx
 * --------------------------------------------------------------------------
...
#endif
#ifdef RTE_UART4_UCLK_PIN_EN
static PIN_ID USART4_pin_clk = { RTE_UART4_UCLK_PORT, RTE_UART4_UCLK_BIT, RTE_UART4_UCLK_FUNC };
#endif
