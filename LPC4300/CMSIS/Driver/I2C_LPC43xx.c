 ...
 * Project:      I2C Driver for NXP LPC43xx
 * --------------------------------------------------------------------------
 ...
 *    - Corrected I2Cx_IRQHandler to work with all Arm Compiler 6 optimization levels (made event variable volatile)
 *  Version 2.6
...
#define MX_I2C0_IRQn       M0S_I2C0_IRQn
#define MX_I2C1_IRQn       M0S_I2C1_IRQn
#define MX_I2C0_IRQHandler M0S_I2C0_IRQHandler
#define MX_I2C1_IRQHandler M0S_I2C1_IRQHandler
#elif (defined(CORE_M0))
#define MX_I2C0_IRQn       M0_I2C0_OR_I2C1_IRQn
#define MX_I2C1_IRQn       M0_I2C0_OR_I2C1_IRQn
#define MX_I2C0_IRQHandler M0_I2C0_IRQHandler
#define MX_I2C1_IRQHandler M0_I2C1_IRQHandler
#else
#define MX_I2C0_IRQn       I2C0_IRQn
#define MX_I2C1_IRQn       I2C1_IRQn
#define MX_I2C0_IRQHandler I2C0_IRQHandler
#define MX_I2C1_IRQHandler I2C1_IRQHandler
#endif

/* I2C core clock (system_LPC43xx.c) */
...
static int32_t I2Cx_Uninitialize (I2C_RESOURCES *i2c) {
  ...
  if (i2c->reg == LPC_I2C0) {
    SCU_I2C_PinConfigure (0U);
  }
  else if (i2c->reg == LPC_I2C1) { 
    SCU_PinConfigure (RTE_I2C1_SCL_PORT, RTE_I2C1_SCL_PIN, 0U);
    SCU_PinConfigure (RTE_I2C1_SDA_PORT, RTE_I2C1_SDA_PIN, 0U);
  }
...
static int32_t I2Cx_PowerControl (ARM_POWER_STATE state, I2C_RESOURCES *i2c) {
  ...
  switch (state) {
    case ARM_POWER_OFF:
      ...
      LPC_RGU->RESET_CTRL1 = (i2c->rgu_val | (~(LPC_RGU->RESET_ACTIVE_STATUS1)));
    ...
    case ARM_POWER_FULL:
      ...
      /* Connect base clock */
      *i2c->base_clk_reg = (1U    << 11) |    /* Autoblock En               */
                           (0x09U << 24) ;    /* PLL1 is APB  clock source  */
...
static uint32_t I2Cx_MasterHandler (I2C_RESOURCES *i2c) {
  ...
  switch (i2c->reg->STAT & 0xF8U) {
   ...
   case I2C_STAT_MA_DR_A:
      ...
      i2c->ctrl->data[i2c->ctrl->cnt++] = i2c->reg->DAT & 0xFFU;
      i2c->ctrl->num--;
upd_conset:
      conset = 0U;
      if (i2c->ctrl->num > 1U) {
...
slaw_a:
    ...
    case I2C_STAT_SL_DR_A:
      /* Data received, ACK returned */
      i2c->ctrl->sdata[i2c->ctrl->cnt++] = i2c->reg->DAT & 0xFFU;
      i2c->ctrl->snum--;
      if (i2c->ctrl->snum) {
        conset = I2C_CON_AA;
      }
