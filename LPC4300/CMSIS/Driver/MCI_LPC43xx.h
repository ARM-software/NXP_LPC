 ...
 * $Revision:    V2.8
 *
 * Project:      MCI Driver Definitions for NXP LPC43xx
 * -------------------------------------------------------------------------- */

#ifndef __MCI_LPC43XX_H
#define __MCI_LPC43XX_H
...
#error "SDMMC is not availalble for Cortex-M0SUB!"
#elif (defined(CORE_M0))
#define MX_SDIO_IRQn       M0_SDIO_IRQn
#define MX_SDIO_IRQHandler M0_SDIO_IRQHandler
#else
#define MX_SDIO_IRQn       SDIO_IRQn
#define MX_SDIO_IRQHandler SDIO_IRQHandler
#endif
