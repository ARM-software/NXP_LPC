 ...
 * Project:      SPI (SSP used for SPI) Driver for NXP LPC43xx
 * --------------------------------------------------------------------------
...
#define MX_SSP1_IRQn               M0S_SSP0_OR_SSP1_IRQn
#define MX_SSP0_IRQHandler         M0S_SSP0_IRQHandler
#define MX_SSP1_IRQHandler         M0S_SSP1_IRQHandler
#define MX_SSP0_OR_SSP1_IRQHandler M0S_SSP0_OR_SSP1_IRQHandler
#elif (defined(CORE_M0))
#define MX_SSP0_IRQn               M0_SSP0_OR_SSP1_IRQn
#define MX_SSP1_IRQn               M0_SSP0_OR_SSP1_IRQn
#define MX_SSP0_IRQHandler         M0_SSP0_IRQHandler
#define MX_SSP1_IRQHandler         M0_SSP1_IRQHandler
#define MX_SSP0_OR_SSP1_IRQHandler M0_SSP0_OR_SSP1_IRQHandler
#else
#define MX_SSP0_IRQn               SSP0_IRQn
#define MX_SSP1_IRQn               SSP1_IRQn
#define MX_SSP0_IRQHandler         SSP0_IRQHandler
...
static SSP_RESOURCES SSP0_Resources = {
  ...
  { CGU_BASE_SSPx_CLK_AUTOBLOCK | ((CLK_SRC_PLL1 << 24) & CGU_BASE_SSPx_CLK_CLK_SEL),
    ...
    CCU1_CLK_M4_SSPx_CFG_AUTO | CCU1_CLK_M4_SSPx_CFG_RUN,
    &(LPC_CCU1->CLK_M4_SSP0_CFG),
    CCU1_CLK_M4_SSPx_STAT_RUN,
    &(LPC_CCU1->CLK_M4_SSP0_STAT) },
...
static SSP_RESOURCES SSP1_Resources = {
  ...
  { CGU_BASE_SSPx_CLK_AUTOBLOCK | ((CLK_SRC_PLL1 << 24) & CGU_BASE_SSPx_CLK_CLK_SEL),
    ...
    CCU1_CLK_M4_SSPx_CFG_AUTO | CCU1_CLK_M4_SSPx_CFG_RUN,
    &(LPC_CCU1->CLK_M4_SSP1_CFG),
    CCU1_CLK_M4_SSPx_STAT_RUN,
    &(LPC_CCU1->CLK_M4_SSP1_STAT) },
...
static ARM_SPI_STATUS SSP0_GetStatus           (void)                                              { return SSPx_GetStatus    (&SSP0_Resources); }
       ...
       void           MX_SSP0_IRQHandler       (void)                                              { SSPx_IRQHandler          (&SSP0_Resources); }
...
static ARM_SPI_STATUS SSP1_GetStatus           (void)                                              { return SSPx_GetStatus    (&SSP1_Resources); }
       ...
       void           MX_SSP1_IRQHandler       (void)                                              { SSPx_IRQHandler          (&SSP1_Resources); }
...
void MX_SSP0_OR_SSP1_IRQHandler (void) {
#if (RTE_SSP0)
  MX_SSP0_IRQHandler();
#endif
#if (RTE_SSP1)
