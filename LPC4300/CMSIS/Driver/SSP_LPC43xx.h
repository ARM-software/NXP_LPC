 ...
 * $Revision:    V2.4
 *
 * Project:      SSP Driver Definitions for NXP LPC43xx
 * -------------------------------------------------------------------------- */

#ifndef __SSP_LPC43XX_H
#define __SSP_LPC43XX_H
...
#define CCU1_CLK_M4_SSPx_CFG_RUN          (0x01U << 0)      /*!< CCU1 CLK_M4_SSPx_CFG: RUN Mask          */
#define CCU1_CLK_M4_SSPx_CFG_AUTO         (0x01U << 1)      /*!< CCU1 CLK_M4_SSPx_CFG: AUTO Mask         */
#define CCU1_CLK_M4_SSPx_CFG_WAKEUP       (0x01U << 2)      /*!< CCU1 CLK_M4_SSPx_CFG: WAKEUP Mask       */
#define CCU1_CLK_M4_SSPx_STAT_RUN         (0x01U << 0)      /*!< CCU1 CLK_M4_SSPx_STAT: RUN Mask         */
#define CCU1_CLK_M4_SSPx_STAT_AUTO        (0x01U << 1)      /*!< CCU1 CLK_M4_SSPx_STAT: AUTO Mask        */
#define CCU1_CLK_M4_SSPx_STAT_WAKEUP      (0x01U << 2)      /*!< CCU1 CLK_M4_SSPx_STAT: WAKEUP Mask      */
...
typedef const struct {
  ...
  int32_t               irq_num;        // SSP IRQ number
